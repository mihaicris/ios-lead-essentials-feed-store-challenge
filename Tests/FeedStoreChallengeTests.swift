...
//
    ...
    private func testSpecificArtifactsDirectoryURL() -> URL {
        return cachesDirectory().appendingPathComponent("\(type(of: self))")
    }

    private func testSpecificStoreURL() -> URL {
        return testSpecificArtifactsDirectoryURL().appendingPathComponent("CoreDataStore.sqlite")
    }
...
//        deleteStoreArtifacts()
    ...
    private func deleteStoreArtifacts() {
        try? FileManager.default.removeItem(at: testSpecificArtifactsDirectoryURL())
    }
